...
while opcion != 4:
    ...
    if opcion == 1: # Añadir un elemento a la lista (append).
        print("")
        articulo = input("Teclea un nuevo artículo para añadirlo a la lista de la compra: ")
        ...
        if articulo in listaCompra:
            ...
            print(f"El artículo '{articulo}' fue añadido a la lista.")
            print("")
            input("Pulsa una tecla para continuar...")
        ...
        print("")
        articulo = input("Teclea un nuevo artículo para borrarlo de la lista de la compra: ")
        articulo = articulo.capitalize()
        print("")
        if articulo in listaCompra:
            ...
            print(f"El artículo '{articulo}' no está dentro de la lista.")
            print("")
            input("Pulsa una tecla para continuar...")
        ...
        longLista = len(listaCompra)
        print("")
        print("Listado de los elementos;")
        print("")
        for c in range(0,longLista):
            articulo = listaCompra[c]
            print(f"- {articulo}.")
        print("")
        input("Pulsa una tecla para continuar...")